...
project = "nextcord-ext-help-commands"
copyright = "2022 Nextcord"
author = "Nextcord"
...
with open("../nextcord/ext/help_commands/__init__.py") as stream:
...
html_title = "nextcord-ext-help-commands"

html_theme_options = {
    "repository_url": "https://github.com/nextcord/nextcord-ext-help-commands",
    "path_to_docs": "docs",
